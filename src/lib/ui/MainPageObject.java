...
public class MainPageObject {
    ...
    public void assertElementHasText(String locator, String waiting_value, String error_message) {
        WebElement title_element = waitForElementPresent(locator,
                "Cannot find article title: " + locator,
                15);
    ...
    protected void swipeUp(int timeOfSwipe) {
        ...
        action.press(point(x, start_y)).waitAction(waitOptions(ofMillis(timeOfSwipe))).moveTo(point(x, end_y)).release().perform();
    }
    ...
    public void swipeUpIsElementAppear(String locator, String error_message, int max_swipes) {
        int already_swiped = 0;
    ...
    public void assertElementNotPresent(String locator, String error_message) {
        ...
        if (amount_of_elements > 0) {
            String default_message = String.format("An element %s supposed to be not present", locator);
    ...
    public void assertElementPresent(String locator, String error_message) {
        int amount_of_elements = getAmountOfElements(locator);
        if (amount_of_elements == 0) {
            String default_message = String.format("An element %s supposed to be present", locator);
            throw new AssertionError(default_message + " " + error_message);
        }
    }
